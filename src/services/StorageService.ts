...
class StorageService {
  ...
  public saveScore(scoreData: Partial<Score> | Score, scoreId?: string, folderId: string | null = null, userId?: string): ScoreMeta {
    ...
    const completeScore: Score = {
      ...
      tempo: scoreData.tempo !== undefined ? scoreData.tempo : 120,
      showTempo: scoreData.showTempo !== undefined ? !!scoreData.showTempo : true,
      ...
      octaveDotSize: scoreData.octaveDotSize || 6,
